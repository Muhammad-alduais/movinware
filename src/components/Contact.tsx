              ...
              >
                {isSubmitting ? (
                  <>
                    ...
                    <span data-i18n="contact.form.sending">{t('contact.form.sending')}</span>
                  </>
                ) : submitStatus === 'success' ? (
                  <>
                    <CheckCircle className="w-4 h-4 mr-2" />
                    <span data-i18n="contact.form.success">{t('contact.form.success')}</span>
                  </>
                ) : submitStatus === 'error' ? (
                  <>
                    <AlertCircle className="w-4 h-4 mr-2" />
                    <span data-i18n="contact.form.tryAgain">{t('contact.form.tryAgain')}</span>
                  </>
                ) : (
                  <>
