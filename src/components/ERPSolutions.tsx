            ...
            >
              <div className="bg-white rounded-3xl p-8 border border-gray-200 hover:border-gray-300 transition-all duration-500 hover:shadow-xl h-full flex flex-col">
                <div className="flex items-start mb-6">
                  <div className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center ltr:mr-4 rtl:ml-4 group-hover:bg-pulse-50 transition-all duration-500 flex-shrink-0">
                    <solution.icon className="w-7 h-7 text-gray-600 group-hover:text-pulse-500 transition-all duration-500" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="text-xl font-medium text-gray-900 mb-3 ltr:pr-2 rtl:pl-2 leading-tight text-left rtl:text-right">{solution.title}</h3>
                    <div className="mb-3">
                ...
                >
                  ...
                  <ArrowRight className="w-4 h-4 ltr:ml-2 rtl:mr-2 group-hover:translate-x-1 rtl:group-hover:-translate-x-1 transition-transform duration-300 rtl:rotate-180" />
                </div>
              </div>
            </div>
          ))}
