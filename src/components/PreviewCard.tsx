...
const PreviewCard = ({ 
  ...
  return (
    <div 
      className={`
        group opacity-0 animate-slide-up bg-white rounded-3xl p-8 border border-gray-200 rtl:text-right
    ...
    >
      <div className="flex items-start mb-6 rtl:flex-row-reverse">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-xl font-medium text-gray-900 mb-2 pr-2 rtl:pr-0 rtl:pl-2">{title}</h3>
          {(timeline || metric) && (
            <div className="mb-3">
